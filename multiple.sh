...
echo "Desti.w 5555ds- https://t.me/softs_by_wesna"
echo "===================================================================================================================================="
...
install_node() {
    ...
    # Привязка аккаунта
    ./multiple-cli bind --bandwidth-download 12207 --identifier $IDENTIFIER --pin $PIN --storage 2097152 --bandwidth-upload 12207
